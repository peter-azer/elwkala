...
class OrderController extends Controller
{
        ...
        try {
            $orders = Order::with([
                ...
                ->map(function ($order) {
                    ...
                    $order->assigned_user = optional($order->assignedOrders->first()?->users->first())->only('id', 'name');
    ...
    {
        try {
            $order = Order::where('order_id', $id)->with('market', 'product', 'product.productsPacksSizes')->get();
